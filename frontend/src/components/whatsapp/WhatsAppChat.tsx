  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      {showHeader && contactName && (
        <div className="flex-shrink-0 px-4 py-3 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center gap-3">
            ...
            {Array.from(groupedMessages.entries()).map(([date, dateMessages]) => (
              <div key={date}>
                ...
                <div className="flex justify-center my-3">
                  <span className="px-3 py-1 text-xs bg-white/80 dark:bg-slate-700/80 text-slate-600 dark:text-slate-400 rounded-lg shadow-sm">
                    ...
                    <div
                      className={`relative max-w-[75%] px-3 py-2 rounded-lg shadow-sm ${
                        msg.direction === 'outbound'
                          ? 'bg-[#dcf8c6] dark:bg-emerald-900/70'
      ...
      {/* Input Area */}
      <div className="flex-shrink-0 px-4 py-3 bg-slate-100 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 px-4 py-2.5 text-sm bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-full text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
          />
          <button
            onClick={handleSend}
