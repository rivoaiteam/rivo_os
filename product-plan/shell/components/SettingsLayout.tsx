 import { ArrowLeft, Settings, Megaphone, FileText, Users, Shield, Clock, AlertCircle, Handshake, MessageSquare } from 'lucide-react'
...
const settingsGroups: SettingsGroup[] = [
  ...
  },
  {
    ...
    label: 'Rules',
    sections: [
      { id: 'sla-rules', label: 'SLA Rules', icon: <Clock className="w-4 h-4" /> },
      { id: 'drop-off-reasons', label: 'Drop-off Reasons', icon: <AlertCircle className="w-4 h-4" /> },
    ],
  },
  {
    id: 'team',
  ...
  },
  {
    ...
    label: 'Partners',
    sections: [
      { id: 'partner-list', label: 'Partner List', icon: <Handshake className="w-4 h-4" /> },
    ],
  },
  {
    id: 'templates',
    label: 'Templates',
    sections: [
      { id: 'message-templates', label: 'Message Templates', icon: <MessageSquare className="w-4 h-4" /> },
    ],
  },
]
